Here are some challenge ideas that avoid complexity, can be solved using web3.js or APIs, and focus on backend code using nestjs and MongoDB. Choose 3 tasks that you are confident in and can do.
